...
nv.models.multiBarHorizontalV1 = function() {
        "use strict";
            ...
            selection.each(function(data) {
                ...
                if (stacked)
                    bars.watchTransition(renderWatch, 'multibarhorizontal: bars')
                        ...
                        .attr('height', x.rangeBand() *0.2);//height of rect while stacked 20%
                else
                    bars.watchTransition(renderWatch, 'multibarhorizontal: bars')
                        .attr('transform', function(d,i) {
                            //TODO: stacked must be all positive or all negative, not both?
                        ...
                        .select('rect')
                        .attr('height', (x.rangeBand() / data.length) *0.4 )//height of rect while grouped 40%
                        .attr('width', function(d,i) {
                            return Math.max(Math.abs(y(getY(d,i)) - y(0)),1) || 0
                        });
...
nv.models.multiBarHorizontalChart = function() {
    ...
    var multibar = nv.models.multiBarHorizontalV1()
        , xAxis = nv.models.axis()
        , yAxis = nv.models.axis()
